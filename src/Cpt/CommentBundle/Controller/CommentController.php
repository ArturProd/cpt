...
class CommentController extends BaseController
{
    ...
    public function getNewCommentsAction()
    {
         $this->RestrictAccessToAjax();

        $sourceid = $this->GetNumericParameter('sourceid'); 
        $aftercommentid = $this->GetNumericParameter('aftercommentid', -1);  
        
        $comments = $this->getCommentManager()->get_newer_comments($sourceid, $aftercommentid);
        $user = $this->getUser();
